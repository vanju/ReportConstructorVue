<script>
    ...
    import MenuBuilderProvider from '/src/libs/where-menu-builder.js';
    ...
    export default {
        ...
        async created() {
            let response = await this.$fetch('/expression-node/tree/?id=' + this.rootId + '&clause=where', { method: 'GET', mock: false });
